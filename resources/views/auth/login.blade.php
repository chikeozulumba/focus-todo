    ...
    <form class="mt-8 space-y-6" action="/login" method="POST">
      ...
      <div class="-space-y-px">
        <div class="rounded-md shadow-sm">
          <div>
            ...
            <input id="email-address" name="email" type="email" autocomplete="email" required class="appearance-none font-medium rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-gray-500 focus:border-gray-500 focus:z-10 sm:text-sm" placeholder="Email address" value="{{ old('email') }}">
          </div>
          <div>
            <label for="password" class="sr-only">Password</label>
            <input id="password" name="password" type="password" autocomplete="current-password" required class="appearance-none font-medium rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-gray-500 focus:border-gray-500 focus:z-10 sm:text-sm" placeholder="Password">
          </div>
        </div>
        @if($errors->any())
      ...
      <div>
        ...
        <div class="text-xs text-center mt-4">
          <a href="/register" class="font-medium text-gray-600 hover:text-gray-500">
            Create an account
          </a>
        </div>
      </div>
